...
namespace Framework.Helper
{
    public class ReportHelper
    {
        ...
        public static void AddTestResult(Exception testError)
        {

            Step.Fail($"{testError.Message} {testError.StackTrace}", MediaEntityBuilder.CreateScreenCaptureFromPath(ScreenshotHelper.ScreenshotFilePath).Build());
        }
